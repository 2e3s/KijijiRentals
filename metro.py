...
class Metro:
    _stations: List[Tuple[float, float, str, int, int]] = [
        # Orange line
        (45.5561, -73.6673, 'Henri-Bourassa', 4, FULL_ELEVATOR),
        (45.5506, -73.6560, 'Sauve', 5, NO_ELEVATOR),
        (45.5457, -73.6381, 'Cremazie', 5, NO_ELEVATOR),
        (45.5432, -73.6284, 'Jarry', 6, NO_ELEVATOR),
        (45.5396, -73.6136, 'Jean-Talon', 8, FULL_ELEVATOR),
        ...
        (45.50194, -73.56306, 'Square-Victoria–OACI', 6, NO_ELEVATOR),
        (45.4980, -73.5668, 'Bonaventure', 5, FULL_ELEVATOR),
        (45.4950, -73.5709, 'Lucien L\'Allier', 5, NO_ELEVATOR),
        (45.4889, -73.5765, 'Georges-Vanier', 5, NO_ELEVATOR),
        (45.4771, -73.5865, 'Place Saint-Henri', 4, PARTIAL_ELEVATOR),
        (45.473889, -73.603889, 'Vendome', 4, FULL_ELEVATOR),
        (45.4796, -73.6198, 'Villa-Maria', 6, PARTIAL_ELEVATOR),
        ...
        (45.5203, -73.615, 'Outremont', 6, PARTIAL_ELEVATOR),
        (45.5303, -73.624, 'Parc extension', 0, NO_ELEVATOR),
        (45.5353, -73.620, 'De Castelnau', 3, NO_ELEVATOR),
        (45.5465, -73.6081, 'Fabre', 2, NO_ELEVATOR),
        (45.5538, -73.6021, 'D\'Iberville', 1, PARTIAL_ELEVATOR),
        (45.55972, -73.60000, 'St-Michel', 1, NO_ELEVATOR),
        # Green line
        (45.4462, -73.6037, 'Terminus Angrignon', 4, PARTIAL_ELEVATOR),
        (45.4509, -73.5934, 'Monk', 6, NO_ELEVATOR),
        (45.4568, -73.5820, 'Jolicoeur', 6, PARTIAL_ELEVATOR),
        (45.4592, -73.5715, 'Verdun', 7, NO_ELEVATOR),
        (45.4618, -73.5665, 'De l\'Eglise', 7, NO_ELEVATOR),
        (45.4708, -73.5661, 'Station Lasalle', 6, NO_ELEVATOR),
        (45.4782, -73.5693, 'Charlevoix', 4, NO_ELEVATOR),
        (45.4828, -73.5797, 'Lionel Groulx', 6, FULL_ELEVATOR),
        (45.4893, -73.5841, 'Atwater', 7, PARTIAL_ELEVATOR),
        (45.4945, -73.5808, 'Guy-Concordia', 3, NO_ELEVATOR),
        (45.5009, -73.5747, 'Peel', 4, NO_ELEVATOR),
        (45.5039, -73.5714, 'McGill ', 4, PARTIAL_ELEVATOR),
        (45.5081, -73.5686, 'Place-des-Arts', 6, PARTIAL_ELEVATOR),
        (45.5108, -73.5648, 'Saint-Laurent', 6, NO_ELEVATOR),
        (45.5190, -73.5559, 'Beaudry', 7, NO_ELEVATOR),
        (45.5237, -73.5521, 'Papineau', 7, NO_ELEVATOR),
        (45.5335, -73.5522, 'Frontenac', 7, NO_ELEVATOR),
        (45.5415, -73.5543, 'Prefontaine', 8, PARTIAL_ELEVATOR),
        (45.5470, -73.5515, 'Station Joliette', 10, NO_ELEVATOR),
        (45.5540, -73.5519, 'Pie-IX', 10, PARTIAL_ELEVATOR),
        (45.5612, -73.5472, 'Viau', 8, FULL_ELEVATOR),
        (45.5692, -73.5469, 'Assomption', 3, NO_ELEVATOR),
        (45.5769, -73.5467, 'Cadillac', 2, NO_ELEVATOR),
        (45.5828, -73.5431, 'Langelier', 1, NO_ELEVATOR),
        (45.5889, -73.5394, 'Radisson', 1, NO_ELEVATOR),
        (45.5967, -73.5356, 'Honoré-Beaugrand', 1, FULL_ELEVATOR),
        # Yellow
        (45.5253, -73.5219, 'Longueuil', 2, NO_ELEVATOR),
    ]
