...
class Metro:
    stations = [
        ...
        # Green line
        [45.4462, -73.6037, 'Terminus Angrignon', 60],
        [45.4509, -73.5934, 'Monk', 70],
        [45.4568, -73.5820, 'Jolicoeur', 90],
        [45.4592, -73.5715, 'Verdun', 60],
        [45.4618, -73.5665, 'De l\'Eglise', 60],
        [45.4708, -73.5661, 'Station Lasalle', 60],
        ...
        [45.5237, -73.5521, 'Papineau', 60],
        # [45.5335, -73.5522, 'Frontenac', 60],
        # [45.5415, -73.5543, 'Prefontaine', 50],
        [45.5470, -73.5515, 'Station Joliette', 40],
